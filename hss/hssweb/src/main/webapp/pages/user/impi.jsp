...
<%@ taglib uri="http://jakarta.apache.org/struts/tags-logic"
	prefix="logic"%>
<%@ page import="java.util.*, org.freeims.hss.server.model.*, org.freeims.hss.common.WebConstants " %>
...
<jsp:useBean id="associated_IMSU" class="org.freeims.hss.server.model.IMSU" scope="request"></jsp:useBean>
