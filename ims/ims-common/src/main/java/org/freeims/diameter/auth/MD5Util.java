...
package org.freeims.diameter.auth;
...
public class MD5Util {
	...
	public static byte []  calcResponse(byte[] _ha1,    /* H(A1) */
	                    		   ...
	                    		   byte [] _method,     /* method from the request */
	                    		   byte []  _uri,       /* requested URL */
	                    		   byte [] _nc, 		/* 8 hex digits */
	                    		   byte [] _cnonce,		/* client nonce */
	                    		   byte [] _qop,		/* qop-value: "", "auth", "auth-int" */
	                    		   int _auth_int,		/* 1 if auth-int is used */
	                    		   byte [] _hentity)   	/* H(entity body) if qop="auth-int*/
	...
	public static byte[] calc_H(byte [] ent)
	{
		byte [] RespHash;
    	byte [] _response;
