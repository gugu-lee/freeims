...
//                } else {
                if ((request != null) && (request instanceof SipProxyRequestWrapper)){
                    filter.doFilter(((SipProxyRequestWrapper)request).getRequest(), response, this);
                }else{
...
//                }
        ...
        try {
            ...
            if (request != null && request.isAsyncSupported() && !servletSupportsAsync) {
            ...
            if ((request != null && request instanceof SipProxyRequestWrapper)/* &&
                    (response instanceof SipProxyResponseWrapper)*/){
...
//                                               principal);
//                } else {
                    servlet.service(((SipProxyRequestWrapper)request).getRequest(), response);
//                }
            } else {
