...
public final class ApplicationFilterFactory {
    ...
    public static ApplicationFilterChain createFilterChain
        ...
        if (request instanceof SipProxyRequest) {
        	SipProxyRequestImpl req = (SipProxyRequestImpl) request;
        ...
        SipProxyContext context = (SipProxyContext) wrapper.getParent();
        ...
        for (int i = 0; i < filterMaps.length; i++) {
            ...
            wrapper.getLogger().info("filterMaps["+i+"]:"+filterMaps[i]);
            wrapper.getLogger().info("requestPath:"+requestPath);
            if (!matchFiltersURL(filterMaps[i], requestPath)){
            	wrapper.getLogger().info("not matchFiltersURL");
                continue;
            }
            ...
            if (filterConfig == null) {
            	...
            	wrapper.getLogger().info("filterConfig is null");
                continue;
            }
            wrapper.getLogger().info("add filter,"+filterConfig.getFilterClass());
