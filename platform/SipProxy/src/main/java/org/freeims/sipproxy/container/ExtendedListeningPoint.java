 ...
 *
 */
public interface ExtendedListeningPoint {
	 ...
	 * 
	 * @param findUsePublicAddress
	 *            whehter or not to return the ip address found through STUN
	 *            discovery
	 * @return
	 */
	...
	/**
	 * get the list of ip addresses this connector is tied to (in case of
	 * binding to 0.0.0.0 there can be many)
	 * 
	 * @return the list of ip addresses this connector is tied to (in case of
	 *         binding to 0.0.0.0 there can be many)
	 */
	 ...
	 * 
	 * @param branch
	 *            branch value to use for the via header to create, null will
	 *            return an auto generated one or will be assigend later by the
	 *            stack
	 * @param usePublicAddress
	 *            wether or not to use the ip address found by STUN discovery
	 ...
	 * 
	 * @param displayName
	 *            the display name to use for the contact header to create
	 * @param userName
	 *            the user name to use for the contact header to create
	 * @param usePublicAddress
	 *            wether or not to use the ip address found by STUN discovery
	 * @return a Contact Header based on this SIP Listening Point
	 */
	ContactHeader createContactHeader(String displayName, String userName, boolean usePublicAddress);
	 ...
	 * @param usePublicAddress
	 *            wether or not to use the ip address found by STUN discovery
	 * @param outboundInterface
	 *            the outbound interface ip address to be used for the host part
	...
	/**
	 * return true if the ip address maps to 0.0.0.0. If it's true call
	 * getIpAddresses ti get the real list of ip addresses it maps too
	 * 
