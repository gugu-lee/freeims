 ...
 *
 */
public class ExtendedListeningPointImpl implements ExtendedListeningPoint {
	private static final Log logger = LogFactory.getLog(ExtendedListeningPointImpl.class);		
...
//	String host = null;
	 ...
	 * 
	 */
	public ExtendedListeningPointImpl(SipProvider sipProvider, ListeningPointExt listeningPoint, SipConnector sipConnector) {
