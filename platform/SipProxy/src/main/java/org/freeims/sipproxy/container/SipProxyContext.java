 ...
 */
public class SipProxyContext extends ContainerBase
        implements Context, NotificationEmitter {

    private static final Log log = LogFactory.getLog(SipProxyContext.class);
     ...
     */
    public SipProxyContext() {

        super();
        pipeline.setBasic(new SipProxyContextValve());
     ...
     */
    private String wrapperClassName = SipProxyWrapper.class.getName();
    ...
    public void setWrapperClass(String wrapperClassName) {
        ...
        try {
            ...
            if (!SipProxyWrapper.class.isAssignableFrom(wrapperClass)) {
                throw new IllegalArgumentException(
    ...
    public long getProcessingTime() {
        ...
        if (children != null) {
            for( int i=0; i< children.length; i++ ) {
                result += ((SipProxyWrapper)children[i]).getProcessingTime();
            }
        }
    ...
    public long getMaxTime() {
        ...
        if (children != null) {
            for( int i=0; i< children.length; i++ ) {
                time = ((SipProxyWrapper)children[i]).getMaxTime();
                if (time > result)
                    result = time;
            }
        }
    ...
    public long getMinTime() {
        ...
        if (children != null) {
            for( int i=0; i< children.length; i++ ) {
                time = ((SipProxyWrapper)children[i]).getMinTime();
    ...
    public int getRequestCount() {
        ...
        if (children != null) {
            for( int i=0; i< children.length; i++ ) {
                result += ((SipProxyWrapper)children[i]).getRequestCount();
            }
        }
    ...
    public int getErrorCount() {
        ...
        if (children != null) {
            for( int i=0; i< children.length; i++ ) {
                result += ((SipProxyWrapper)children[i]).getErrorCount();
            }
        }
            ...
            for (Wrapper wrapper : list) {
                try {
                    ...
                    getLogger().error(sm.getString("standardContext.loadOnStartup.loadException",
                          getName(), wrapper.getName()), SipProxyWrapper.getRootCause(e));
