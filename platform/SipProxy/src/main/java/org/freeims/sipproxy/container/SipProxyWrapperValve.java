 ...
 */
final class SipProxyWrapperValve
    extends ValveBase {

    //------------------------------------------------------ Constructor
    public SipProxyWrapperValve() {
        super(true);
    }
    ...
    public final void invoke(Request request, Response response)
        ...
        SipProxyWrapper wrapper = (SipProxyWrapper) getContainer();
        ...
        try {
            ...
            container.getLogger().error(sm.getString("standardWrapper.allocateException",
                             wrapper.getName()), SipProxyWrapper.getRootCause(e));
            throwable = e;
        ...
        try {
            ...
            Throwable rootCause = SipProxyWrapper.getRootCause(e);
