...
import org.freeims.core.ThreadAuditor;
...
import org.freeims.javax.sip.parser.MessageParser;
import org.freeims.javax.sip.parser.ParseExceptionListener;
...
//            if (sipMessage instanceof SIPRequest &&((SIPRequest) sipMessage).getMethod().equals(Request.REGISTER))
//            {
...
//                		}else{
//                			
//                			logger.logInfo("contact.address is not SipUri:"+c.getAddress().getClass().getName());
//                		}
//                	}else{
