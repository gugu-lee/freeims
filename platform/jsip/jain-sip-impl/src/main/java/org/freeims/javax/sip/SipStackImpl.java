...
import org.freeims.core.LogLevels;
import org.freeims.core.ServerLogger;
import org.freeims.core.StackLogger;
import org.freeims.core.net.AddressResolver;
import org.freeims.core.net.DefaultSecurityManagerProvider;
import org.freeims.core.net.NetworkLayer;
import org.freeims.core.net.SecurityManagerProvider;
import org.freeims.core.net.SslNetworkLayer;
import org.freeims.javax.sip.clientauthutils.AccountManager;
import org.freeims.javax.sip.clientauthutils.AuthenticationHelper;
import org.freeims.javax.sip.clientauthutils.AuthenticationHelperImpl;
import org.freeims.javax.sip.clientauthutils.SecureAccountManager;
import org.freeims.javax.sip.parser.MessageParserFactory;
import org.freeims.javax.sip.parser.PostParseExecutorServices;
import org.freeims.javax.sip.parser.StringMsgParser;
import org.freeims.javax.sip.parser.StringMsgParserFactory;
import org.freeims.javax.sip.stack.ByteBufferFactory;
import org.freeims.javax.sip.stack.ClientAuthType;
import org.freeims.javax.sip.stack.ConnectionOrientedMessageProcessor;
import org.freeims.javax.sip.stack.DefaultMessageLogFactory;
import org.freeims.javax.sip.stack.DefaultRouter;
import org.freeims.javax.sip.stack.MessageProcessor;
import org.freeims.javax.sip.stack.MessageProcessorFactory;
import org.freeims.javax.sip.stack.OIOMessageProcessorFactory;
import org.freeims.javax.sip.stack.SIPEventInterceptor;
import org.freeims.javax.sip.stack.SIPMessageValve;
import org.freeims.javax.sip.stack.SIPTransactionStack;
import org.freeims.javax.sip.stack.SocketTimeoutAuditor;
import org.freeims.javax.sip.stack.timers.DefaultSipTimer;
import org.freeims.javax.sip.stack.timers.SipTimer;
 ...
 * org.freeims.javax.sip.STACK_LOGGER and org.freeims.javax.sip.SERVER_LOGGER for
 ...
 * 
 * <li><b>org.freeims.javax.sip.DEBUG_LOG = fileName </b> <b> Use of this property
 * is still supported but deprecated. Please use org.freeims.javax.sip.STACK_LOGGER
 * and org.freeims.javax.sip.SERVER_LOGGER for integration with logging frameworks
 ...
 * 
 * <li><b>org.freeims.javax.sip.LOG_STACK_TRACE_ON_MESSAGE_SEND = true|false </b><br/>
 ...
 * 
 * <li><b>org.freeims.javax.sip.AUTOMATIC_DIALOG_ERROR_HANDLING = [true|false] </b>
 * <br/>
 ...
 * </ul>
 * 
 * <li><b>org.freeims.javax.sip.IS_BACK_TO_BACK_USER_AGENT = [true|false] </b> <br/>
 ...
 * 
 * <li><b>org.freeims.javax.sip.DELIVER_TERMINATED_EVENT_FOR_NULL_DIALOG = [true|false] </b><br/>
 ...
 * </li>
 * 
 * <li><b>org.freeims.javax.sip.CACHE_SERVER_CONNECTIONS = [true|false] </b> <br/>
 ...
 * 
 * 
 * <li><b>org.freeims.javax.sip.CACHE_CLIENT_CONNECTIONS = [true|false] </b> <br/>
 * Default value is true. Setting this to false makes the Stack close the server
 ...
 * 
 * <li><b>org.freeims.javax.sip.DELIVER_TERMINATED_EVENT_FOR_ACK = [true|false]</b>
 * <br/>
 ...
 * org.freeims.core.net.NetworkLayer. The default implementation simply acts as a
 ...
 * 
 * <li><b>org.freeims.javax.sip.THREAD_AUDIT_INTERVAL_IN_MILLISECS = long </b> <br/>
 ...
 * </li>
 * 
 * <li><b>org.freeims.javax.sip.stack.USE_DIRECT_BUFFERS = [true|false]</b> <br/>
 ...
 * </li>
 * 
 * <li><b>org.freeims.javax.sip.DELIVER_UNSOLICITED_NOTIFY = [true|false] </b> <br/>
 ...
 * dialog.</li>
 * 
 * <li><b>org.freeims.javax.sip.REJECT_STRAY_RESPONSES = [true|false] </b> Default
 ...
 * 
 * <li><b>org.freeims.javax.sip.MAX_FORK_TIME_SECONDS = integer </b> Maximum time for which the original 
 ...
 * 
 * <li><b>org.freeims.javax.sip.EARLY_DIALOG_TIMEOUT_SECONDS=integer </b> Maximum time for which a dialog
 * can remain in early state. This is defaulted to 3 minutes ( 180 seconds).
 * </li>
 * 
 * <li><b>org.freeims.javax.sip.THREAD_PRIORITY=integer </b> Control the priority of the threads started by the stack.
 * </li> 
 * 
 * <li><b>org.freeims.javax.sip.MESSAGE_PARSER_FACTORY =  name of the class implementing org.freeims.javax.sip.parser.MessageParserFactory</b>
 ...
 * 
 * <li><b>org.freeims.javax.sip.MESSAGE_PROCESSOR_FACTORY =  name of the class implementing org.freeims.javax.sip.parser.MessageProcessorFactory</b>
 ...
 * 
 * <li><b>org.freeims.javax.sip.TIMER_CLASS_NAME =  name of the class implementing org.freeims.javax.sip.stack.timers.SipTimer</b> interface
 ...
 * 
 * <li><b>org.freeims.javax.sip.DELIVER_RETRANSMITTED_ACK_TO_LISTENER=boolean</b> A testing property
 * that allows application to see the ACK for retransmitted 200 OK requests. <b>Note that this is for test
 * purposes only</b></li>
 * 
 * * <li><b>org.freeims.javax.sip.AGGRESSIVE_CLEANUP=boolean</b> A property that will cleanup Dialog, and Transaction structures
 ...
 * 
 * <li><b>org.freeims.javax.sip.MIN_KEEPALIVE_TIME_SECONDS = integer</b> Minimum time between keep alive
 ...
 * </li>
 * 
 * <li><b>org.freeims.javax.sip.DIALOG_TIMEOUT_FACTOR= integer</b> Default to 64. The number of ticks before a
 ...
 * </li>
 * 
 * <li><b>org.freeims.javax.sip.SIP_MESSAGE_VALVE= String</b> Default to null. The class name of your custom valve component.
 ...
 * </li>
 * 
 * <li><b>org.freeims.javax.sip.SIP_EVENT_INTERCEPTOR</b> Default to null. The class name of your custom interceptor object.
 * An instance of this object will be created at initialization of the stack. You must implement the interface
 * org.freeims.javax.sip.stack.SIPEventInterceptor and handle the lifecycle callbacks. This interface is the solution for 
 ...
 *  is <b>org.freeims.javax.sip.stack.CallAnalysisInterceptor</b>, which will periodically check for requests stuck in the
 ...
 *  of this feature is that you must use  org.freeims.javax.sip.REENTRANT_LISTENER=true to ensure that the request will be
 ...
 * </li>
 * 
 * <li><b>org.freeims.javax.sip.TLS_SECURITY_POLICY = String </b> The fully qualified path
 * name of a TLS Security Policy implementation that is consulted for certificate verification
 * of outbund TLS connections.
 * </li>
 * 
 * <li><b>org.freeims.javax.sip.TLS_CLIENT_AUTH_TYPE = String </b> Valid values are Default (backward compatible with previous versions)
 ...
 * </li>
 *
 *<li><b>org.freeims.javax.sip.RELIABLE_CONNECTION_KEEP_ALIVE_TIMEOUT</b> Value in seconds which is used as default keepalive timeout
 * (See also http://tools.ietf.org/html/rfc5626#section-4.4.1). Defaults to "infiinity" seconds (i.e. timeout event not delivered).</li>
 * 
 * <li><b>org.freeims.javax.sip.SSL_HANDSHAKE_TIMEOUT</b> Value in seconds which is used as default timeout for performing the SSL Handshake
 * This prevents bad clients of connecting without sending any data to block the server</li>
 * 
 * <li><b>org.freeims.javax.sip.SSL_RENEGOTIATION_ENABLED = [true|false]</b> Default value is <b>true</b>. Allow or disallow SSL renegotiation to resolve potential DoS problem - 
...
public class SipStackImpl extends SIPTransactionStack implements
	...
	private void reInitialize() {
		...
		if(!getTimer().isStarted()) {			
			String defaultTimerName = configurationProperties.getProperty("org.freeims.javax.sip.TIMER_CLASS_NAME",DefaultSipTimer.class.getName());
			try {				
	...
	public SipStackImpl(Properties configurationProperties)
		...
		super.setReliableConnectionKeepAliveTimeout(1000 * Integer.parseInt(
			        configurationProperties.getProperty("org.freeims.javax.sip.RELIABLE_CONNECTION_KEEP_ALIVE_TIMEOUT", "-1")));
		...
		super.setThreadPriority(Integer.parseInt(
			        configurationProperties.getProperty("org.freeims.javax.sip.THREAD_PRIORITY","" + Thread.MAX_PRIORITY)));
		...
		super.isDialogTerminatedEventDeliveredForNullDialog = (Boolean.parseBoolean(configurationProperties.getProperty("org.freeims.javax.sip.DELIVER_TERMINATED_EVENT_FOR_NULL_DIALOG",
		        Boolean.FALSE.toString())));
		...
		super.minKeepAliveInterval = Integer.parseInt(configurationProperties.getProperty("org.freeims.javax.sip.MIN_KEEPALIVE_TIME_SECONDS","-1"));
		
		super.deliverRetransmittedAckToListener = Boolean.parseBoolean(configurationProperties.getProperty
				("org.freeims.javax.sip.DELIVER_RETRANSMITTED_ACK_TO_LISTENER","false"));
		
		super.dialogTimeoutFactor = Integer.parseInt(configurationProperties.getProperty("org.freeims.javax.sip.DIALOG_TIMEOUT_FACTOR","64"));
		
		String messageParserFactoryName = configurationProperties.getProperty("org.freeims.javax.sip.MESSAGE_PARSER_FACTORY",StringMsgParserFactory.class.getName());
		try {
		...
		String messageProcessorFactoryName = configurationProperties.getProperty("org.freeims.javax.sip.MESSAGE_PROCESSOR_FACTORY",OIOMessageProcessorFactory.class.getName());
		try {
		...
		String maxIdleTimeString = configurationProperties.getProperty("org.freeims.javax.sip.NIO_MAX_SOCKET_IDLE_TIME", "7200000");
		try {
			super.nioSocketMaxIdleTime = Long.parseLong(maxIdleTimeString);
		} catch (Exception e) {
			logger
				.logError(
						"Bad configuration value for org.freeims.javax.sip.NIO_MAX_SOCKET_IDLE_TIME=" + maxIdleTimeString, e);			
		}
		...
		String interceptorClassName = configurationProperties.getProperty("org.freeims.javax.sip.SIP_EVENT_INTERCEPTOR", null);
	...
	public void addLogAppender(org.apache.log4j.Appender appender) {
		if (this.logger instanceof org.freeims.core.LogWriter) {
			((org.freeims.core.LogWriter) this.logger).addAppender(appender);
		}
	}
	...
	public org.apache.log4j.Logger getLogger() {
		if (this.logger instanceof org.freeims.core.LogWriter) {
			return ((org.freeims.core.LogWriter) this.logger).getLogger();
		}
		return null;
	}
