...
public class HeaderFactoryImpl implements HeaderFactory , HeaderFactoryExt {
    ...
    */
    ...
    public javax.sip.header.ExtensionHeader createExtensionHeader(
        ...
        org.freeims.javax.sip.header.ExtensionHeaderImpl ext =
            new org.freeims.javax.sip.header.ExtensionHeaderImpl();
        ext.setName(name);
        ext.setValue(value);
    ...
    */
    ...
    public HeaderFactoryImpl() {
        stripAddressScopeZones
            = Boolean.getBoolean("org.freeims.core.STRIP_ADDR_SCOPES");
    }
