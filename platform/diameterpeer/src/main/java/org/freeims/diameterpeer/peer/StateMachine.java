...
import org.freeims.diameterpeer.data.DiameterCEA;
import org.freeims.diameterpeer.data.DiameterCER;
import org.freeims.diameterpeer.data.DiameterDPA;
import org.freeims.diameterpeer.data.DiameterDPR;
import org.freeims.diameterpeer.data.DiameterDWA;
import org.freeims.diameterpeer.data.DiameterDWR;
...
public class StateMachine {
	...
	public static int process(Peer p, int event, DiameterMessage msg,Communicator comm)
	{
		...
		if (msg != null){
		LOGGER.debug("message flagRequest:"+msg.flagRequest);
		}
	synchronized(p){
		switch (p.state){
			case Closed:
